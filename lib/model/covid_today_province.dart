...
List<Covid19ThProvince> covid19ThProvinceFromJson(String str) => List<Covid19ThProvince>.from(json.decode(str).map((x) => Covid19ThProvince.fromJson(x)));

String covid19ThProvinceToJson(List<Covid19ThProvince> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class Covid19ThProvince {
    ...
    factory Covid19ThProvince.fromJson(Map<String, dynamic> json) => Covid19ThProvince(
